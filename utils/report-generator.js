 ...
 *
 * Layout: one section per page, browser tabs
 * (Chromium / Firefox / Edge) within each section.
 *
 * Output: CPCBA-results/YYYY-MM-DD/report.html
 * ===========================================
 */
...
function generateConsolidatedReport({ allResults, regressions, reportPath, today }) {
  ...
  // ─── Group results by page, preserving order ──────────────────────────
  const pageGroups = {};
  const pageOrder = [];
  ...
  // ─── Sidebar navigation (one entry per page) ──────────────────────────
  ...
  // ─── Helper: build the content panel for one browser result ───────────
...
REFERENCE: ${helpUrl}`;
  ...
  // ─── Main sections (one per page, with browser tabs) ──────────────────
