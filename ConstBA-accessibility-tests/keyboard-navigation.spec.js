/**
 * ===========================================
 * KEYBOARD NAVIGATION TEST — ConstBA
 * ===========================================
 ...
 *
 * HOW TO RUN:
 * npx playwright test ConstBA-accessibility-tests/keyboard-navigation.spec.js --config=constba.config.js --reporter=list
 * ===========================================
 */
...
const baseResultsDir = path.join(__dirname, '..', 'ConstBA-results', today, 'keyboard');
